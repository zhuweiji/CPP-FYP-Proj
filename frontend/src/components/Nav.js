...
const ResponsiveAppBar = (props) => {
  ...
  const redirectToTutorialListPage = useCallback(
    () => navigate("/tutorials", { replace: false }),
    [navigate]
  );
  const redirectToInstructionsPage = useCallback(
    () => navigate("/instructions", { replace: false }),
    [navigate]
  );
  const redirectToGamesPage = useCallback(
